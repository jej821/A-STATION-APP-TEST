...
class SearchPW extends StatefulWidget {
  @override
  SearchPWState createState() => SearchPWState();
}

class SearchPWState extends State<SearchPW> {
  final _formKey = GlobalKey<FormState>();
  String userId, userName, userPhoneNo = '';
  FocusNode userIdFocusNode, userNameFocusNode, userPhoneNoFocusNode = FocusNode();
      ...
      child: RaisedButton(
          ...
          onPressed: () {
            if (_formKey.currentState.validate()) {
              ...
              setState(() {
                _futureUser = createUser(userId, userName, userPhoneNo);
              });
            }
          }),
    );
  ...
  Future<String> createUser(String id, String name, String phone) async {
    final http.Response response = await http.post(
      'http://10.0.2.2:8080/search_pw',
      headers: <String, String>{
        'Content-Type': 'application/json',
        'Charset': 'utf-8'
      },
      body: jsonEncode(<String, String>{'id': id, 'name': name, 'phone': phone}),
    );
